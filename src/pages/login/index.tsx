...
const MainLogin = () => {
  ...
  return (
    <>
      ...
      <Container>
        <Logo onClick={() => console.log(newUser)}>
          <Image alt="" src={logo} />
        </Logo>
        <Logo style={{ gap: 24 }}>
          <div
          ...
          >
            Nao possui uma conta ? Criar conta
          </span>
        </Logo>
        <InputContainer>
          <Input
          ...
          <RecoveryPass onClick={() => router.push("/recover")}>
            Esqueceu a senha ?
          </RecoveryPass>
        </InputContainer>
        <InputContainer
        ...
        >
          <Btn_Entrar
            onClick={() => login(newUser[0].email, newUser[0].password)}
          >
            Entrar
          </Btn_Entrar>
        </InputContainer>
