...
const Spaceman = () => {
  ...
  const citiesCol = useMemo(() => collection(db, "spaceman"), []);
  ...
  return (
    <>
      ...
      <Container>
        <Navbar />
        <MainContent>
          <div style={{ color: colors.green, fontWeight: 600 }}>SPACEMAN</div>
          ...
          <SignalsContainer>
            ...
            <GameContainer>
              <iframe
                src="https://go.aff.7k-partners.com/gpp634wj?source_id=space"
