...
const Roletabrasileira = () => {
  ...
  const citiesCol = useMemo(() => collection(db, "roleta-brasileira"), []);
  ...
  useMemo(() => {
    const unsubscribe = onSnapshot(myQuery, (querySnapshot) => {
      ...
      querySnapshot.forEach((doc) => {
        ...
        dataRes.push({
          cover: data.cover,
          enter_columns: data.enter_columns,
      ...
      <Container>
        ...
        <MainContent>
          ...
          <SignalsContainer>
                  ...
                  item.cover !== "WIN" && item.cover !== "RED" ? (
                    ...
                    >
                      ...
                      <ItemBlock2>
                        ...
                        <div style={{ fontSize: 12 }}>{item.last_number}</div>
                      </ItemBlock2>
                      <ItemBlock2>
                        <div
                          style={{
                        ...
                        <div style={{ fontSize: 12 }}>{item.protect}</div>
                      </ItemBlock2>
                    </ItemResult>
                  ) : (
                    <>
                      ...
                      {item.cover == "RED" && (
                        ...
                        >
                          ...
                          <ItemBlock2>
                            ...
                            <div style={{ fontSize: 12, background: "red" }}>
                              LOSS
                            </div>
                          </ItemBlock2>
                        </ItemResult>
            ...
            <GameContainer>
              <iframe
                src="https://go.aff.7k-partners.com/jactegnn?source_id=roletabr"
...
export default Roletabrasileira;
