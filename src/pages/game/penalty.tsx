...
const Penalty = () => {
  ...
  const citiesCol = useMemo(() => collection(db, "penalty"), []);
  ...
  return (
    <>
      <Container>
        <Navbar />
        <MainContent>
          <div style={{ color: colors.green, fontWeight: 600 }}>PENALTY</div>
          ...
          <SignalsContainer>
              ...
              {dataList.length > 0 &&
                dataList.map((item: any, i: number) => (
                  ...
                  >
                    ...
                    <ItemBlock2>
                      Saida<div>{item.exit}</div>
                    </ItemBlock2>
                    <ItemBlock2>
                      Tentativas<div>{item.attempt}</div>
                    </ItemBlock2>
                    <ItemBlock2>
                      Estrategia<div>{item.strategy}</div>
                    </ItemBlock2>
                    <ItemBlock2>
                      Validade<div>{item.validity}</div>
                    </ItemBlock2>
                    <ItemBlock3>
                      Entrada
                      <div>
            ...
            <GameContainer>
              <iframe
                src="https://go.aff.7k-partners.com/kuap8boz?source_id=Penalty"
